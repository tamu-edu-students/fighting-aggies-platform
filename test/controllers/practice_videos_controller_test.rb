...
class PracticeVideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice_video" do
    assert_difference("PracticeVideo.count") do
      post practice_videos_url, params: { practice_video: { description: @practice_video.description, filename: @practice_video.filename, video_create_date: @practice_video.video_create_date, video_name: @practice_video.video_name, video_upload_date: @practice_video.video_upload_date } }
    end
  ...
  test "should update practice_video" do
    patch practice_video_url(@practice_video), params: { practice_video: { description: @practice_video.description, filename: @practice_video.filename, video_create_date: @practice_video.video_create_date, video_name: @practice_video.video_name, video_upload_date: @practice_video.video_upload_date } }
